...
function initInputs() {
  ...
  el.saveBtn?.addEventListener("click", submitIncome);
}
...
async function openCategoryPopup() {
  ...
  const res = await fetch(`${CONFIG.API_BASE}/categories?type=income`, {
    credentials: "include"
  });
...
async function submitIncome() {
  ...
  const res = await fetch(`${CONFIG.API_BASE}/transactions/income`, {
    method: "POST",
    credentials: "include",
